...
-- insert into baseline_alarm_config (id, description, severity, enable, type, class, kpi_type, baseline_type, upper_thres, lower_thres, pid, kpi_method, days)
-- values (11, 'HTTP Query Response Time', 1, true, 8, 8, 9008, 0, 0, 0, 11, 1, 31);
insert into baseline_alarm_config (id, description, severity, enable, type, class, kpi_type, baseline_type, upper_thres, lower_thres, pid, kpi_method, days)
values (12, 'SMB RTT', 1, true, 8, 8, 9007, 0, 0, 0, 12, 1, 31);
insert into baseline_alarm_config (id, description, severity, enable, type, class, kpi_type, baseline_type, upper_thres, lower_thres, pid, kpi_method, days)
values (13, 'CRT-Site', 1, true, 8, 8, 9012, 0, 0, 0, 13, 1, 31);
insert into baseline_alarm_config (id, description, severity, enable, type, class, kpi_type, baseline_type, upper_thres, lower_thres, pid, kpi_method, days)
values (14, 'NRT-Site', 1, true, 8, 8, 9013, 0, 0, 0, 14, 1, 31);
insert into baseline_alarm_config (id, description, severity, enable, type, class, kpi_type, baseline_type, upper_thres, lower_thres, pid, kpi_method, days)
values (15, 'SRT-Site', 1, true, 8, 8, 9014, 0, 0, 0, 15, 1, 31);
insert into baseline_alarm_config (id, description, severity, enable, type, class, kpi_type, baseline_type, upper_thres, lower_thres, pid, kpi_method, days)
values (16, 'CRT-Server Group', 1, true, 8, 8, 9015, 0, 0, 0, 16, 1, 31);
insert into baseline_alarm_config (id, description, severity, enable, type, class, kpi_type, baseline_type, upper_thres, lower_thres, pid, kpi_method, days)
values (17, 'NRT-Server Group', 1, true, 8, 8, 9016, 0, 0, 0, 17, 1, 31);
insert into baseline_alarm_config (id, description, severity, enable, type, class, kpi_type, baseline_type, upper_thres, lower_thres, pid, kpi_method, days)
values (18, 'SRT-Server Group', 1, true, 8, 8, 9017, 0, 0, 0, 18, 1, 31);